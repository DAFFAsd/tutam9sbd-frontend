  ...
  return (
    <div className="flex items-center justify-center h-screen w-full px-5 sm:px-0 bg-gradient-to-br from-slate-900 to-zinc-900">
      <div className="bg-gray-800 rounded-lg shadow-lg overflow-hidden max-w-sm lg:max-w-4xl w-full p-8">
        ...
        <p className="text-xl text-gray-200 text-center font-poppins">Registration successful! Welcome aboard!</p>
        <div className="mt-8 flex justify-center">
          <Link to="/login" className="bg-purple-600 text-gray-200 font-bold font-poppins py-2 px-4 rounded hover:bg-purple-700">
            Go to Login
          </Link>
        </div>
      </div>
